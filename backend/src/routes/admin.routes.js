...
router.patch('/users/:id/block', validate({ body: admin.setUserBlockedSchema }), admin.setUserBlocked)
router.get('/users/:id/sessions', admin.getUserSessions)
router.delete('/users/:id/sessions/:sid', admin.revokeUserSession)
router.delete('/users/:id/sessions', admin.revokeAllUserSessions)
