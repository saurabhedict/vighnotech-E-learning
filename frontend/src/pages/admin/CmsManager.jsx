                  ...
                  <div className="flex items-center gap-3.5 flex-wrap">
                    ...
                    {up ? (
                      ...
                      <div className="flex items-center gap-2">
                        {lesson.enc?.status === 'encrypting' ? (
                          <span className="text-[10px] text-vigno-accent2 font-bold bg-vigno-accent2/10 border border-vigno-accent2/25 px-1.5 py-0.5 rounded flex items-center gap-1">
                            🔒 Encrypting…
                          </span>
                        ) : lesson.enc?.status === 'failed' ? (
                          <span className="text-[10px] text-red-300 font-bold bg-red-500/10 border border-red-500/25 px-1.5 py-0.5 rounded flex items-center gap-1">
                            ⚠ Encrypt failed
                          </span>
                        ) : lesson.storageKey ? (
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2.5 flex-wrap sm:flex-nowrap shrink-0 self-start lg:self-center">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      ) : res.enc?.status === 'encrypting' ? (
                        <span className="w-8 h-8 rounded-xl flex items-center justify-center bg-vigno-accent2/10 border border-vigno-accent2/20 text-vigno-accent2 shrink-0 select-none text-sm" title="Encrypting…">
                          🔒
                        </span>
                      ) : res.enc?.status === 'failed' ? (
                        <span className="w-8 h-8 rounded-xl flex items-center justify-center bg-red-500/10 border border-red-500/20 text-red-300 shrink-0 select-none text-sm" title="Encryption failed">
                          ⚠
                        </span>
                      ) : res.storageKey ? (
