// Full list of countries with ISO-2 code, name and international dial code.
// Flag emoji is derived from the ISO code (regional indicator letters).
export const COUNTRIES = [
  ...
  { iso: 'VI', name: 'Virgin Islands (U.S.)', dial: '+1340' },
...
// Set of all known dial codes — for parsing a stored E.164 number back.
